...
model.add(Dense(units=1000,activation='relu'))# structuring input model of ANN
...
training_set=train_datagen.flow_from_directory('Util/train',target_size=(64,64),batch_size=50,class_mode='binary')
val_set=val_datagen.flow_from_directory('Util/valid',target_size=(64,64),batch_size=50,class_mode='binary')

model.fit_generator(training_set,steps_per_epoch=5,epochs=10,validation_data=val_set,validation_steps=2)
# saving the model
model.save('SKD.h5')
